            ...
            <div class="modal-body">
                <div class="row mb-3">
                    <div class="col">
                        ...
                        <input type="text" name="nama_barang" required class="form-control" placeholder="Masukkan Nama Seragam">
                    </div>
                </div>
                <div class="row mb-3">
                    <div class="col">
                        <label for="">Harga</label>
                        <input type="text" name="harga" required class="form-control" placeholder="Masukkan Harga">
                    </div>
                </div>
        ...
        <form action="{{url('/seragam/update/' . $d->id)}}" method="post">
            ...
            <div class="modal-body">
                <div class="row mb-3">
                    <div class="col">
                        <label for="">Seragam</label>
                        <input type="text" name="nama_barang" required class="form-control" placeholder="Masukkan Nama Seragam" value="{{$d->nama_barang}}">
                    </div>
                </div>
                <div class="row mb-3">
                    <div class="col">
                        <label for="">Harga</label>
                        <input type="text" name="harga" required class="form-control" placeholder="Masukkan Harga" value="{{$d->harga}}">
                    </div>
                </div>
